...
public static void main(String[] args) {
		...
		double totalComDesconto = 0, tributos;
			...
			String[][] produtos = { { "1", "Mouse", "10", "10.5" },
					{ "2", "Teclado", "10", "40.0" },
					{ "3", "Monitor", "10", "90.0" },
					{ "4", "Fone", "10", "60.0" },
					{ "5", "Microfone", "10", "30.0" } };
			...
			String[] payment = {"À vista (dinheiro, pix ou cartão MasterdCard)você tem 20% de desconto!",
					...
					"Parcelado em 2x infelizmente não tem desconto.",
					"Parcelado em 3x infelizmente não tem desconto."};
